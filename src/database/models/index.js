...
const defineInventoryMovementModel = require('../../modules/inventory/models/inventoryMovement.model');
const defineInventoryReservationModel = require('../../modules/inventory/models/inventoryReservation.model');
...
db.InventoryMovement = defineInventoryMovementModel(sequelize, DataTypes);
db.InventoryReservation = defineInventoryReservationModel(sequelize, DataTypes);
