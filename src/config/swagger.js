      ...
      schemas: {
        ...
        OrderStatusUpdateRequest: {
          ...
          properties: {
            ...
            reason: { type: 'string', nullable: true, example: 'Customer requested cancellation' },
            notes: { type: 'string', nullable: true, example: 'Refund to be processed after inspection' },
          },
        },
        AuthMergeSummary: {
          type: 'object',
